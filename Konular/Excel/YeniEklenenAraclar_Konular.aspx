...
<asp:Content ID="Content1" ContentPlaceHolderID="SayfaIcerik" Runat="Server">
            ...
            <h1>Yeni Eklenen Araçlar</h1>
<p>Bu kısımda Excel'e 2013 versiyonu ve sonrasında eklenen ileri seviye araçları ele alıyor olacağız</p>
...
where (t.AltKonu='Yeni Eklenen Araçlar') and (a.AnaKonu='Excel') order by KonuSiraNo"></asp:SqlDataSource></asp:Content>
