<%@ Page Title='Core VSTO' Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"%>
...
where (t.AltKonu='Core VSTO') and (a.AnaKonu='VSTO') order by KonuSiraNo"></asp:SqlDataSource></asp:Content>
