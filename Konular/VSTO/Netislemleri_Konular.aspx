<%@ Page Title='.Net İşlemleri' Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"%>
...
where (t.AltKonu='.Net İşlemleri') and (a.AnaKonu='VSTO') order by KonuSiraNo"></asp:SqlDataSource></asp:Content>
