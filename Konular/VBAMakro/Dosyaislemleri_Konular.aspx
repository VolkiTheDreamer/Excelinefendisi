<%@ Page Title='Dosyaislemleri Konular' Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"%>
<asp:Content ID="Content1" ContentPlaceHolderID="SayfaIcerik" Runat="Server">
         

<h1>Dosya(I/O) işlemleri</h1>
<p>Bu bölümde klasörlerde gezinme, klasörler ve dosyalar hakkında bilgi alma, 
metin dosyalarının içini okuma, değiştirme ve sıfırdan dosya oluşturma gibi 
işlemlere bakacağız.</p>
...
where (t.AltKonu='Dosya işlemleri') and (a.AnaKonu='VBAMakro') order by KonuSiraNo"></asp:SqlDataSource></asp:Content>
